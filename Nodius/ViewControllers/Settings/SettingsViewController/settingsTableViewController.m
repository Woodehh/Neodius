...
-(void)viewWillAppear:(BOOL)animated {
    ...
    refreshInterval = [[NodiusDataSource sharedData] getIntervalData][[[NodiusDataSource sharedData] getRefreshInterval]];
    [self.tableView reloadData];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        if (indexPath.row == 0) {
            ...
            cell.detailTextLabel.text = [[NodiusDataSource sharedData] switchIntervalLabel:refreshInterval[@"labelValue"]
        ...
        if (indexPath.row == 0) {
            ...
            showTimer.tag = 2;
            showTimer.on = [[NodiusDataSource sharedData] getShowTimer];
            ...
            showMessages.tag = 3;
            showMessages.on = [[NodiusDataSource sharedData] getShowMessages];
        ...
        if (indexPath.row == 0) {
            ...
            useMainNet.tag = 4;
            useMainNet.on = [[NodiusDataSource sharedData] getUseMainNet];
...
-(void)toggleSwitch:(id)sender {
    ...
    if (switchControl.tag == 0) {
        ...
        [[NodiusDataSource sharedData] setShowTimer:switchControl.on];
    } else if (switchControl.tag == 3) {
        [[NodiusDataSource sharedData] setShowMessages:switchControl.on];
    } else if (switchControl.tag == 4) {
        [[NodiusDataSource sharedData] setUseMainNet:switchControl.on];
    }
}
