...
- (void)viewDidLoad {
    ...
    tipJars = [[NodiusDataSource sharedData] getDonationData];
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *shareMessage = [NSString stringWithFormat:NSLocalizedString(@"Feel free to send some %@ in order to make support the Nodius development! :-)", nil), name];
