...
- (void)viewDidLoad {
    ...
    UIImage *qrIcon = [[NodiusDataSource sharedData] tableIconPositive:@"fa-qrcode"];
...
-(void)loadData {
    ...
    [networkManager GET:[[NodiusDataSource sharedData] buildAPIUrlWithEndpoint:[NSString stringWithFormat:@"/address/balance/%@",_walletAddress]]
             parameters:nil
               progress:nil
    ...
    [networkManager GET:[[NodiusDataSource sharedData] buildAPIUrlWithEndpoint:[NSString stringWithFormat:@"/address/claims/%@",_walletAddress]]
             parameters:nil
               progress:nil
                success:^(NSURLSessionTask *task, id responseObject) {
    ...
    [networkManager GET:[[NodiusDataSource sharedData] buildAPIUrlWithEndpoint:[NSString stringWithFormat:@"/address/history/%@",_walletAddress]]
             parameters:nil
               progress:nil
                success:^(NSURLSessionTask *task, id responseObject) {
...
-(UILabel*)formatValueField:(UILabel*)s withLabel:(NSString*)lbl andValue:(NSNumber*)value andType:(int)type {
    ...
    NSMutableAttributedString *valueString = [[NSMutableAttributedString alloc] 
                                              initWithString:[[[NodiusDataSource sharedData] formatNumber:value ofType:type withFiatSymbol:baseFiat[@"symbol"]] stringByTrimmingCharactersInSet:
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (transactions.count == 0) {
        ...
        cell.textLabel.text = [NSString stringWithFormat:@"%@: %@",trxType, [[NodiusDataSource sharedData] formatNumber:trxAmount ofType:3 withFiatSymbol:@""]];
