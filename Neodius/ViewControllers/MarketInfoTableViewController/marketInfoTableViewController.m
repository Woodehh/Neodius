...
- (void)viewDidLoad {
    ...
    UIImage *refreshIcon = [[NeodiusDataSource sharedData] tableIconPositive:@"fa-refresh"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0 || indexPath.section == 1  || indexPath.section == 2) {
        ...
        if (indexPath.section == 0) {
            NSString * cryptoValue = [[NeodiusDataSource sharedData] formatNumber:((src == nil) ? @0 : src) ofType:3 withFiatSymbol:baseFiat[@"symbol"]];
            NSString * fiatValue = [[NeodiusDataSource sharedData] formatNumber:((value == nil) ? @0 : value) ofType:2 withFiatSymbol:baseFiat[@"symbol"]];
            ...
            if (indexPath.row == 0 || indexPath.row == 1) {
                cell.detailTextLabel.text = [[NeodiusDataSource sharedData] formatNumber:((src == nil) ? @0 : src) ofType:2 withFiatSymbol:baseFiat[@"symbol"]];
            } else {
                cell.detailTextLabel.text = src.stringValue;
            }
            
        } else if (indexPath.section == 2) {
            cell.detailTextLabel.text = [[NeodiusDataSource sharedData] formatNumber:((src == nil) ? @0 : src) ofType:4 withFiatSymbol:nil];
        }
    } else if (indexPath.section == 3) {
